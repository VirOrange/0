...
QT_MOC_LITERAL(1, 10, 16), // "chooseScenceBack"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "PlayScene\0chooseScenceBack\0"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayScene::chooseScenceBack)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayScene::chooseScenceBack()
{
